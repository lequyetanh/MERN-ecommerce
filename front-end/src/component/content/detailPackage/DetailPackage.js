...
function DetailPackage() {
  ...
  // console.log(productItemId) console.log(productItemId)
  ...
  useEffect(() => {
    if (product) {
      ...
      dispatch(productAction.get8ProductRelative(product[0].type, product[0].id));
    }
  }, [product])
            ...
            <div className="container py-xl-4 py-lg-2">
              ...
              <div className="row">
                ...
                <div className="col-lg-7 single-right-left simpleCart_shelfItem">
                  ...
                  <p className="mb-3">
                    <span className="item_price">{product.old_price} VND</span>
                    <del className="mx-2 font-weight-light">{product.new_price} VND</del>
